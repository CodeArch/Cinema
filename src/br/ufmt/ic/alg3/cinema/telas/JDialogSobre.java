...
public class JDialogSobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sistema de Gerenciamento de Cinema");

        jLabel2.setText("Por Henrique de Oliveira Peixoto");

        jLabel3.setText("GitHub do Projeto:");

        jTextField1.setEditable(false);
        jTextField1.setText("https://github.com/CodeArch/Cinema");

        jLabel4.setText("Projeto desenvolvido durante a disciplina de Algoritmos III no curso de");

        jLabel5.setText("Ciência da Computação da UFMT. ");
